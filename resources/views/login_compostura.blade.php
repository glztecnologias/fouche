    	...
    	<div class="row">
            ...
            <div>
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#login_empleados" aria-controls="profile" role="tab" data-toggle="tab">Empleados</a></li>
                <li role="presentation" class="active"><a href="#composturas" aria-controls="messages" role="tab" data-toggle="tab">Solicitud Composturas</a></li>
              </ul>
              ...
              <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="login_empleados">
                  <br>
                ...
                <div role="tabpanel" class="tab-pane active" id="composturas">
                  <br>
